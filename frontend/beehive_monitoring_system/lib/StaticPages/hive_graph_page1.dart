import 'package:beehive_monitoring_system/StaticPages/hive_graph_page2.dart';
import 'package:flutter/material.dart';

class HiveGraphPage1 extends StatelessWidget {
  const HiveGraphPage1({super.key});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // ==================================================
              _buildGraphCard(
                imagePath: 'assets/images/rainfall_light_impact.png',
              ),
              ...
              // SECOND GRAPH
              // ==================================================
              _buildGraphCard(imagePath: 'assets/images/bee_hive_activity.png'),
  ...
  Widget _buildOtherGraphsButton(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const HiveGraphPage2()),
        );
      },
